...
//print_r($data);
//print_r($DB->getDepListArr('sky31'));
...
//echo $pass.'//'.$phone;
//$res = $DB->getDepListArr('xtudc');

//    echo count($res);
//$res = $DB->search('sky31',0,'13017127454');
//$res = $DB->getNamePhone('sky31','技术开发部',0,'null','null');
//$res = $DB->getStatus('sky31');
//print_r($res);
//$res= $DB->addMsgRecord('sky31','84654','de','4651',null,null);
...
//------------重置所有，危险代码！！--------
//$org_key = 'sky31';
//$res = $DB->getStatus($org_key);
//foreach ($res as $val){
//    $id = $val['Id'];
//    $json = $val['admit_status'];
...
//    print_r($id.$res.'<br>');
//    $DB->reviseStatus($org_key,$id,$res);
//}
//------------重置所有，危险代码！！--------
