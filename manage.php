            ...
            ?>
                <?php
                    if($_SESSION['user_authority'] == 'root'){
                        ...
                        echo '<ul>
                                  <li class="all left_bot select_status" id="m0"><a href="javascript:void(0);" data-title="全部人员">  全部人员</a></li>
                                  <li class="pass_1 left_bot select_status" id="m1"><a href="javascript:void(0);" data-title="通过初试">   通过初试</a></li>
                                  <li class="out_1 left_bot select_status" id="m2"><a href="javascript:void(0);" data-title="初试淘汰">   初试淘汰</a></li>
                                  <li class="pass_2 left_bot select_status" id="m3"><a href="javascript:void(0);" data-title="通过复试">   通过复试</a></li>
                                  <li class="out_2 left_bot select_status" id="m4"><a href="javascript:void(0);" data-title="复试淘汰">   复试淘汰</a></li>
                                  <li class="pass_3 left_bot select_status" id="m5"><a href="javascript:void(0);" data-title="正式受聘">   正式受聘</a></li>
                              </ul>';
                    }else{
                        echo '                              
                              <div class="tab-content">
                                <ul id="info_look">';
                                   ...
                                   for($i = 0;$i<count($dep_list);$i++){
                                        echo '<li class="left_bot dep_name depname" id="0"><a href="javascript:void(0);" data-title="">'.$dep_list[$i].'</a></li> 
                                              <ul class="dep_status"><li class="all left_bot select_status" id="'.$i.'0"><a href="javascript:void(0);" data-title="'.$dep_list[$i].'全部人员">  全部人员</a></li>
                                               <li class="pass_1 left_bot select_status" id="'.$i.'1"><a href="javascript:void(0);" data-title="'.$dep_list[$i].'通过初试">   通过初试</a></li>
                                               <li class="out_1 left_bot select_status" id="'.$i.'2"><a href="javascript:void(0);" data-title="'.$dep_list[$i].'初试淘汰">   初试淘汰</a></li>
                                               <li class="pass_2 left_bot select_status" id="'.$i.'3"><a href="javascript:void(0);" data-title="'.$dep_list[$i].'通过复试">   通过复试</a></li>
                                               <li class="out_2 left_bot select_status" id="'.$i.'4"><a href="javascript:void(0);" data-title="'.$dep_list[$i].'复试淘汰">   复试淘汰</a></li>
                                               <li class="pass_3 left_bot select_status" id="'.$i.'5"><a href="javascript:void(0);" data-title="'.$dep_list[$i].'正式受聘">   正式受聘</a></li>
                                               </ul>
                                        ';
                                   }
                        echo '</ul>       
                                <ul id="org_revise" style="display:none">   
                                  ...
                                  <li class="org_itd_dtl left_bot"><a href="javascript:void(0);" data-title="详细介绍">   详细介绍</a></li>
                        ...
                        echo '<li class="nav_item search" ><form class="search_form" ><input type="search" name ="search_content" placeholder="Search"></form></li>
                              ...
                              <li class="nav_item"><a href="javascript:void(0);">短信平台</a>
                                <ul>
                                    ...
                                    <li class="reply_list"><a>回复记录</a></li>
                                </ul>
                              </li>
                            <li class="nav_item "><a href="./help.html" target="_blank">帮助</a></li>

                              <li class="nav_item"><a href="logout.php">退出</a><a href="javascript:void(0);">Hello <span id="user_authority">';
                        if($_SESSION['user_authority']=='admin'){
                            echo '负责人';
                        }else{
                            echo $_SESSION['dep_name'].' 部长';
                        }
                        echo '</span> '.$_SESSION['user_name'].'</a></li>';
                    }
                ?>
            </ul>
        ...
        <div class="wrapperInside">
            ...
            <div class="dialogContainer_2">
                ...
                <div class="dialogActionBar">
                    <!-- Buttons -->
                    <a class="buttonTouchTarget" id="buttonOneTouchTarget" href="#">
                                <button class="org_opt_btn org_add_btn
                                <?php
                                if($_SESSION['user_authority']=='admin'){
                                    echo 'admit_status_change_btn';
                                }else if($_SESSION['user_authority']=='ministor'){
                                    echo 'admit_status_change_btn_ministor';
                                }?>
    ...
    <div class="wrapperOutside_3">
        <div class="wrapperInside">
            ...
            <div class="dialogContainer_3">
                <!-- Dialog title and body -->
                <div class="dialogContent">
                    <div class="dialogContentTitle_3" style="font-size: 2em">请再次确认！</div>
