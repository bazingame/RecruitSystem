...
$send_id = $DB->addMsgRecord($org_key,$msg_tpl_id,$dep_name,$status,$no_start,$no_end);//添加发送记录
...
//替换模板并发送
    if($changeType==3){
        $NamePhone_list =$DB->getNamePhone($org_key,$dep_name,$status,$no_start,$no_end);
